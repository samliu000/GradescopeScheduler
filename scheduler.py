...
def getAssignments(courseURL, daSession):
    ...
    for assignment in assignmentList:
        ...
        time = allText[indexOfDueDate:indexOfDueDate+6]
        # timeSpan = assignment.find("span", {"class":"submissionTimeChart--dueDate"})
        
        print("index: " )
        print(indexOfDueDate)
        print("Printing time")
        print(time)
...
for courseUrl in allCourseURLs:
    getAssignments(courseUrl, daSession)
